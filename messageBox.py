...
class MainWindow(QWidget):
    ...
    def programAgreementHandler(self):
        ...
        message.setWindowTitle('User agreement choice')
        message.setText('By clicking "Ok" you agree to the license agreement')
        message.setStandardButtons(QMessageBox.Ok|QMessageBox.Abort)
